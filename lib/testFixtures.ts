    ...
    fixtures: [
      {
        ...
        response: {
          ...
          additional_characteristics: ['golden afternoon light', 'rustling leaves', 'open outdoor setting'],
          inappropriate_content: { flagged: false, reason: null },
      ...
      },
      {
        ...
        response: {
          ...
          new_emotions: ['uncertainty'],
          creative_direction: null,
          story_completeness: 0.3,
          missing_elements: ['colors', 'textures', 'emotional tone', 'time of day', 'abstract symbolism vs. literal depiction'],
          image_type: 'unclear',
          physical_characteristics: [],
          is_race_specific: false,
      ...
      {
        id: 'story_inappropriate',
        label: 'Inappropriate (refusal)',
        description: 'Simulates a flagged racist/inappropriate message — refusal payload, no progression.',
        targetMode: 'elicitation',
        response: {
          reply: "I can't build art around that — it relies on a harmful stereotype about a group of people. I'd love to help with a different memory: maybe something specific that happened to you, and how it actually felt in the moment?",
          detected_emotions: [],
          new_emotions: [],
          creative_direction: null,
          story_completeness: 0,
          missing_elements: ['a different memory to work with'],
          image_type: 'unclear',
          physical_characteristics: [],
          is_race_specific: false,
          additional_characteristics: [],
          inappropriate_content: { flagged: true, reason: 'racist stereotype' },
        } satisfies ElicitationPayload,
      },
    ],
  },
